...
ap.add_argument("-m", "--model", type=str, 	default="faceMask.model", help="path to trained face mask detector model")
...
while True:
	...
	for (box, pred) in zip(locs, preds):
		...
		label = "mask worn :)" if mask > nomask else "no mask :("
		color = (0, 128, 0) if label == "mask worn :)" else (0, 0, 255)
